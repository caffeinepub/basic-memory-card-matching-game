...
export class Backend implements backendInterface {
    ...
    async completeLevel(arg0: Principal, arg1: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.completeLevel(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getCompletedLevelsCount(arg0: Principal): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getCompletedLevelsCount(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isBadgeMinted(arg0: Principal): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isBadgeMinted(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isLevelCompleted(arg0: Principal, arg1: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isLevelCompleted(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
